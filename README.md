...
Sprint 0 established the application foundation. Sprint 1 added confirmed Excel/CSV pole import and KML/KMZ LineString selection. Sprint 2 added local UTM projection, road edges, pole offset lines, and nearest-point placement. Sprint 3 adds selectable schematic spacing; undoable editing and drawing tools; and semantic two-point blocks for side roads, junctions, bridges, and footbridges. Project persistence and export are not implemented yet.
